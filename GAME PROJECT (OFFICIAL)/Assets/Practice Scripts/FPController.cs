...
public class FPController : MonoBehaviour
{
    ...
    public void OnJump(InputAction.CallbackContext context)
    {
        ...
        // Check that theump action was successfully performed and that the player is currently standing on the ground.
        {
            velocity.y = Mathf.Sqrt(jumpHeight * -2f * gravity);
            //Calculates the upward speed needed for the player to reach the chosen jumpheight while accounting for gravity.
        }
    }
